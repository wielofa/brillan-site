...
<div class='pyre_metabox'>
	...
	$this->textarea(
		...
		esc_html__( 'Enter the heading for your slide. This field can take HTML markup and simple Avada Shortcodes that work inside a heading tag.', 'Avada' )
	);
	$this->select(
		'heading_separator',
	...
	$this->textarea(
		...
		esc_html__( 'Enter the caption for your slide. This field can take HTML markup and simple Avada Shortcodes that work inside a heading tag.', 'Avada' )
	);
	$this->select(
		'caption_separator',
	...
	$this->textarea(
		'button_1',
		esc_html__( 'Button #1', 'Avada' ) . '<br/><a href="https://avada.com/documentation/button-element/" target="_blank">' . esc_html__( 'Click here to view button option descriptions.', 'Avada' ) . '</a>',
	...
	$this->textarea(
		'button_2',
		esc_html__( 'Button #2', 'Avada' ) . '<br/><a href="https://avada.com/documentation/button-element/" target="_blank">' . esc_html__( 'Click here to view button option descriptions.', 'Avada' ) . '</a>',
