...
function avada_register_required_and_recommended_plugins() {
	...
	$config = [
		...
		'strings'      => [
			...
			'return'                          => __( 'Return to the Avada Plugins page.', 'Avada' ),
