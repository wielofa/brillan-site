...
class Avada_Demo_Content_Tracker {
	...
	/**
	 * Saves imported ACF data to demo history.
	 *
	 * @access public
	 * @since 7.2
	 * @param array $data Imported Woo attribute IDs.
	 * @return void
	 */
	public function set_acf( $data ) {
		$this->demo_history[ $this->demo_type ]['acf_data'] = $data;
	}
