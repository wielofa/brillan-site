			...
			<div class="awb-wizard-option-group" data-layout="header">
				<div class="pyre_metabox_field layout-input">
					<div class="pyre_desc">
						...
						<p><?php esc_html_e( 'Set your website global header layout. The menu in the header will be generated from the pages selected in the next step, and so, any mega menus within the chosen Studio content will not be included.', 'Avada' ); ?></p>
					</div>
					<div class="pyre_field">
	...
	<section class="awb-setup-wizard-section content-features hidden" data-step="7" data-save="0">
		<div class="awb-setup-wizard-hero">
			<div class="awb-setup-wizard-hero-text">
				...
				<p><?php esc_html_e( 'Select pages (incl. content without images) and additional features to be added to your website.', 'Avada' ); ?></p>
			</div>
		</div>
		...
		<div class="awb-setup-wizard-features">
			...
			<?php
				$features = [
					...
					'maintenance'                 => [
						'label' => __( 'Maintenance Mode', 'Avada' ),
						'type'  => 'feature',
						'icon'  => 'fusiona-power-off',
					],
	...
	<section class="awb-setup-wizard-section finished hidden" data-step="9" data-save="0">
		<div class="awb-setup-wizard-hero">
			<div class="awb-setup-wizard-hero-text">
				...
				<a href="<?php echo esc_url( add_query_arg( 'fb-edit', '1', get_site_url() ) ); ?>" rel="noopener noreferrer" target="_blank" class="button button-primary"><?php esc_html_e( 'Launch Live Builder', 'Avada' ); ?></a>
		...
		<div class="awb-setup-wizard-content">
			...
			<div class="link-grid">
				...
				<a href="<?php echo esc_url( admin_url( 'themes.php?page=avada_options#heading_maintenance' ) ); ?>" rel="noopener noreferrer" target="_blank"><i class="fusiona-power-off"></i><span><strong><?php esc_html_e( 'Coming Soon Mode', 'Avada' ); ?></strong><small><?php esc_html_e( 'Manage Coming Soon mode.', 'Avada' ); ?></small></span></a>
				<a href="<?php echo esc_url( admin_url( 'edit.php?post_type=page' ) ); ?>" rel="noopener noreferrer" target="_blank"><i class="fusiona-documentation"></i><span><strong><?php esc_html_e( 'Pages', 'Avada' ); ?></strong><small><?php esc_html_e( 'Edit the pages of your website.', 'Avada' ); ?></small></span></a>
				<a href="<?php echo esc_url( admin_url( 'admin.php?page=avada-studio' ) ); ?>" rel="noopener noreferrer" target="_blank"><i class="fusiona-avada-logo"></i><span><strong><?php esc_html_e( 'Avada Studio', 'Avada' ); ?></strong><small><?php esc_html_e( 'Add content to your site.', 'Avada' ); ?></small></span></a>
			</div>
	...
	<section class="awb-setup-wizard-section confirm-setup prebuilt-confirm-step hidden" data-step="21" data-save="0">
		...
		<div class="awb-setup-wizard-content">
			...
			<div class="awb-selected-prebuilt-features">
				<ul id="awb-additional-features-list" class="checklist">
					<li class="awb-additional-feature awb-visible">
						<input type="checkbox" class="awb-setup-stage-check checkbox" name="awb-scratch-activate-maintenance" value="maintenance" checked>
						<span class="awb-setup-stage-label"><?php esc_html_e( 'Activate Maintenance Mode', 'Avada' ); ?></span>
					</li>
				</ul>
