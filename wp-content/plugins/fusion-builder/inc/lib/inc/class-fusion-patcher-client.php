...
class Fusion_Patcher_Client {
	...
	private function query_patch_server() {
		...
		if ( is_wp_error( $response ) ) {
			...
			new Fusion_Patcher_Admin_Notices( 'server-unreachable', sprintf( esc_html__( 'The ThemeFusion patches server could not be reached. Please contact your host to unblock the "%s" domain.', 'fusion-builder' ), FUSION_UPDATES_URL ) );
			return false;
		}
