...
class Fusion_Widget_Form extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'form-widget', __( 'Avada: Form', 'fusion-builder' ), $widget_ops, $control_ops );
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'form_id' ) ); ?>"><?php esc_html_e( 'Select Form:', 'fusion-builder' ); ?></label>
