...
class Fusion_Widget_Ad_125_125 extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops  = [
			...
			'description' => __( 'Add 125x125 ads.', 'fusion-builder' ),
		];
		$control_ops = [
			'id_base' => 'ad_125_125-widget',
		];

		parent::__construct( 'ad_125_125-widget', __( 'Avada: 125x125 Ads', 'fusion-builder' ), $widget_ops, $control_ops );
	...
	public function form( $instance ) {
		...
		<p><strong><?php printf( esc_html__( 'Ad %s', 'fusion-builder' ), '1' ); ?></strong></p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'ad_125_img_1' ) ); ?>"><?php esc_html_e( 'Image Ad Link:', 'fusion-builder' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'ad_125_link_1' ) ); ?>"><?php esc_html_e( 'Ad Link:', 'fusion-builder' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'ad_125_hover_type_1' ) ); ?>"><?php esc_html_e( 'Image Hover Type:', 'fusion-builder' ); ?></label>
			<select id="<?php echo esc_attr( $this->get_field_id( 'ad_125_hover_type_1' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'ad_125_hover_type_1' ) ); ?>" class="widefat" style="width:100%;">
				<option value="" <?php echo ( '' === $instance['ad_125_hover_type_1'] ) ? 'selected="selected"' : ''; ?>><?php esc_html_e( 'None', 'fusion-builder' ); ?></option>
				<option value="zoomin" <?php echo ( 'zoomin' === $instance['ad_125_hover_type_1'] ) ? 'selected="selected"' : ''; ?>><?php esc_html_e( 'Zoom In', 'fusion-builder' ); ?></option>
				<option value="zoomout" <?php echo ( 'zoomout' === $instance['ad_125_hover_type_1'] ) ? 'selected="selected"' : ''; ?>><?php esc_html_e( 'Zoon Out', 'fusion-builder' ); ?></option>
				<option value="liftup" <?php echo ( 'liftup' === $instance['ad_125_hover_type_1'] ) ? 'selected="selected"' : ''; ?>><?php esc_html_e( 'Lift Up', 'fusion-builder' ); ?></option>
			</select>
		</p>
		<?php /* translators: Number.*/ ?>
		<p><strong><?php printf( esc_html__( 'Ad %s', 'fusion-builder' ), '2' ); ?></strong></p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'ad_125_img_2' ) ); ?>"><?php esc_html_e( 'Image Ad Link:', 'fusion-builder' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'ad_125_link_2' ) ); ?>"><?php esc_html_e( 'Ad Link:', 'fusion-builder' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'ad_125_hover_type_2' ) ); ?>"><?php esc_html_e( 'Image Hover Type:', 'fusion-builder' ); ?></label>
			<select id="<?php echo esc_attr( $this->get_field_id( 'ad_125_hover_type_2' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'ad_125_hover_type_2' ) ); ?>" class="widefat" style="width:100%;">
				<option value="" <?php echo ( '' === $instance['ad_125_hover_type_2'] ) ? 'selected="selected"' : ''; ?>><?php esc_html_e( 'None', 'fusion-builder' ); ?></option>
				<option value="zoomin" <?php echo ( 'zoomin' === $instance['ad_125_hover_type_2'] ) ? 'selected="selected"' : ''; ?>><?php esc_html_e( 'Zoom In', 'fusion-builder' ); ?></option>
				<option value="zoomout" <?php echo ( 'zoomout' === $instance['ad_125_hover_type_2'] ) ? 'selected="selected"' : ''; ?>><?php esc_html_e( 'Zoon Out', 'fusion-builder' ); ?></option>
				<option value="liftup" <?php echo ( 'liftup' === $instance['ad_125_hover_type_2'] ) ? 'selected="selected"' : ''; ?>><?php esc_html_e( 'Lift Up', 'fusion-builder' ); ?></option>
			</select>
		</p>
		<?php /* translators: Number.*/ ?>
		<p><strong><?php printf( esc_html__( 'Ad %s', 'fusion-builder' ), '3' ); ?></strong></p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'ad_125_img_3' ) ); ?>"><?php esc_html_e( 'Image Ad Link:', 'fusion-builder' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'ad_125_link_3' ) ); ?>"><?php esc_html_e( 'Ad Link:', 'fusion-builder' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'ad_125_hover_type_3' ) ); ?>"><?php esc_html_e( 'Image Hover Type:', 'fusion-builder' ); ?></label>
			<select id="<?php echo esc_attr( $this->get_field_id( 'ad_125_hover_type_3' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'ad_125_hover_type_3' ) ); ?>" class="widefat" style="width:100%;">
				<option value="" <?php echo ( '' === $instance['ad_125_hover_type_3'] ) ? 'selected="selected"' : ''; ?>><?php esc_html_e( 'None', 'fusion-builder' ); ?></option>
				<option value="zoomin" <?php echo ( 'zoomin' === $instance['ad_125_hover_type_3'] ) ? 'selected="selected"' : ''; ?>><?php esc_html_e( 'Zoom In', 'fusion-builder' ); ?></option>
				<option value="zoomout" <?php echo ( 'zoomout' === $instance['ad_125_hover_type_3'] ) ? 'selected="selected"' : ''; ?>><?php esc_html_e( 'Zoon Out', 'fusion-builder' ); ?></option>
				<option value="liftup" <?php echo ( 'liftup' === $instance['ad_125_hover_type_3'] ) ? 'selected="selected"' : ''; ?>><?php esc_html_e( 'Lift Up', 'fusion-builder' ); ?></option>
			</select>
		</p>
		<?php /* translators: Number.*/ ?>
		<p><strong><?php printf( esc_html__( 'Ad %s', 'fusion-builder' ), '4' ); ?></strong></p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'ad_125_img_4' ) ); ?>"><?php esc_html_e( 'Image Ad Link:', 'fusion-builder' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'ad_125_link_4' ) ); ?>"><?php esc_html_e( 'Ad Link:', 'fusion-builder' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'ad_125_hover_type_4' ) ); ?>"><?php esc_html_e( 'Image Hover Type:', 'fusion-builder' ); ?></label>
			<select id="<?php echo esc_attr( $this->get_field_id( 'ad_125_hover_type_4' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'ad_125_hover_type_4' ) ); ?>" class="widefat" style="width:100%;">
				<option value="" <?php echo ( '' === $instance['ad_125_hover_type_4'] ) ? 'selected="selected"' : ''; ?>><?php esc_html_e( 'None', 'fusion-builder' ); ?></option>
				<option value="zoomin" <?php echo ( 'zoomin' === $instance['ad_125_hover_type_4'] ) ? 'selected="selected"' : ''; ?>><?php esc_html_e( 'Zoom In', 'fusion-builder' ); ?></option>
				<option value="zoomout" <?php echo ( 'zoomout' === $instance['ad_125_hover_type_4'] ) ? 'selected="selected"' : ''; ?>><?php esc_html_e( 'Zoon Out', 'fusion-builder' ); ?></option>
				<option value="liftup" <?php echo ( 'liftup' === $instance['ad_125_hover_type_4'] ) ? 'selected="selected"' : ''; ?>><?php esc_html_e( 'Lift Up', 'fusion-builder' ); ?></option>
			</select>
		</p>
		<p><strong><?php esc_html_e( 'General Options', 'fusion-builder' ); ?></strong></p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'ad_125_link_target' ) ); ?>"><?php esc_html_e( 'Link Target:', 'fusion-builder' ); ?></label>
			<select id="<?php echo esc_attr( $this->get_field_id( 'ad_125_link_target' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'ad_125_link_target' ) ); ?>" class="widefat" style="width:100%;">
				<option value="_self" <?php echo ( '_self' === $instance['ad_125_link_target'] ) ? 'selected="selected"' : ''; ?>><?php esc_html_e( '_self', 'fusion-builder' ); ?></option>
				<option value="_blank" <?php echo ( '_blank' === $instance['ad_125_link_target'] ) ? 'selected="selected"' : ''; ?>><?php esc_html_e( '_blank', 'fusion-builder' ); ?></option>
			</select>
		</p>
		<?php
