...
class AWB_Widget_Framework {
	...
	public function add_side_nav_optionsto_go_extras() {
		$options = [
			'sidenav_behavior'   => [
				'label'       => esc_html__( 'Side Navigation Behavior', 'fusion-builder' ),
				'description' => esc_html__( 'Controls if the child pages show on click or hover for the side navigation page template.', 'fusion-builder' ),
				'id'          => 'sidenav_behavior',
				'default'     => 'hover',
			...
			'side_nav_font_size' => [
				'label'       => esc_html__( 'Side Navigation Font Size', 'fusion-builder' ),
				'description' => esc_html__( 'Controls the font size for the menu text when using the side navigation page template.', 'fusion-builder' ),
